...
# import time of magi_core.api.config). Tests must be hermetic and not depend on
...
def _isolate_env(monkeypatch):
    ...
    magi_core.api.config is reset before and after each test so neither developer
