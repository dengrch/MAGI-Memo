...
sys.argv = [sys.argv[0]]
_server = importlib.import_module("magi_core.api.lightrag_server")
_utils_pipeline = importlib.import_module("magi_core.utils_pipeline")
sys.argv = _original_argv

from magi_core.base import DocStatusStorage  # noqa: E402
from magi_core.kg.json_doc_status_impl import JsonDocStatusStorage  # noqa: E402
