...
_shared_storage = importlib.import_module("magi_core.kg.shared_storage")
_admission = importlib.import_module("magi_core.api.admission")
_middleware_mod = importlib.import_module("magi_core.api.admission_middleware")
_utils_api = importlib.import_module("magi_core.api.utils_api")
...
async def test_api_prefix_is_stripped_before_matching():
    ...
    await _mw(rag, downstream, api_prefix="/magi_core")(
        _scope(path="/magi_core/documents/upload"), recorder.receive, recorder.send
    )
