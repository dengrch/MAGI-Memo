...
from magi_core.base import SourceAbsent  # noqa: E402
from magi_core.constants import PARSED_DIR_NAME  # noqa: E402
...
def _ensure_shared_storage_initialized():
    ...
    importlib.import_module("magi_core.kg.shared_storage").initialize_share_data()
    yield
...
def test_an_unusable_spool_directory_fails_the_scan_closed(
    ...
    async def _run():
        ...
        lightrag_logger = importlib.import_module("magi_core.utils").logger
...
def test_batch_size_falls_back_when_unconfigured(monkeypatch):
    ...
    from magi_core.constants import DEFAULT_SCAN_ENQUEUE_BATCH_SIZE
