...
sys.argv = [sys.argv[0]]
_dr = importlib.import_module("magi_core.api.routers.document_routes")
...
from magi_core.constants import (  # noqa: E402
    PROCESS_OPTION_CHUNK_FIXED,
    PROCESS_OPTION_CHUNK_PARAGRAH,
    PROCESS_OPTION_CHUNK_RECURSIVE,
    PROCESS_OPTION_CHUNK_VECTOR,
)
from magi_core.parser.routing import default_chunker_config  # noqa: E402
