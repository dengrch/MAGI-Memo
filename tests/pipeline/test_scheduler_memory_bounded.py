...
from magi_core.base import CURSOR_END, CURSOR_START, CursorAfter, DocStatus
from magi_core.pipeline import _AUTO_RESUME_DOC_STATUSES, _PipelineMixin
...
class _SyntheticDocStatus:
    ...
    async def get_docs_by_statuses_page(
        ...
        from magi_core.base import DocSchedulingRecord, DocStatusPage
