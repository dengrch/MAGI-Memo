...
from magi_core.base import CURSOR_END, CURSOR_START
from magi_core.pipeline import (
...
from magi_core.utils_pipeline import CUSTOM_CHUNK_PATCH_METADATA_KEY
...
async def test_enqueue_publishes_documents_inside_status_lock(tmp_path, monkeypatch):
    ...
    import magi_core.kg.shared_storage as shared_storage_module
