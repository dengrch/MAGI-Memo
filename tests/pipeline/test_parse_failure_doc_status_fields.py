...
from magi_core.utils_pipeline import doc_status_parse_failure_fields
...
async def test_parse_worker_logs_when_failed_upsert_itself_fails(
    ...
    try:
        ...
        # magi_core logger has propagate=False; enable it so caplog captures.
        lightrag_logger = logging.getLogger("magi_core")
        monkeypatch.setattr(lightrag_logger, "propagate", True)
        with caplog.at_level(logging.ERROR, logger="magi_core"):
            await rag.apipeline_process_enqueue_documents()
