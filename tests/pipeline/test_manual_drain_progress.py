...
from magi_core.base import CURSOR_END, CURSOR_START, DocStatus
from magi_core.constants import CUSTOM_CHUNK_PATCH_METADATA_KEY
from magi_core.exceptions import PipelineRecoveryRequiredError
from magi_core.kg.shared_storage import get_namespace_data, get_pipeline_ingress
...
def test_force_reset_endpoint_unblocks_the_documented_recovery_order(tmp_path):
    ...
    dr = importlib.import_module("magi_core.api.routers.document_routes")
    _sys.argv = _argv
...
def test_drain_progress_counter_resets_on_a_changing_id_set(tmp_path):
    ...
    from magi_core.pipeline import _MANUAL_DRAIN_STALL_ROUNDS, _ManualDrainProgress
