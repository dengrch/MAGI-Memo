...
from magi_core.base import DocStatusStorage
...
from magi_core.utils_pipeline import enforce_strict_storage_capabilities
...
def test_gaps_are_warned_with_their_operator_facing_consequence(caplog):
    # magi_core's logger does not propagate, so caplog needs it turned on.
...
def test_a_broken_probe_never_blocks_startup(monkeypatch):
    ...
    import magi_core.utils_pipeline as utils_pipeline
...
def test_the_paging_capabilities_are_not_part_of_the_gate():
    ...
    from magi_core.utils_pipeline import _CAPABILITY_CONSEQUENCES
