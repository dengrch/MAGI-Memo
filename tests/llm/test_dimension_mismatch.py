...
from magi_core.kg.qdrant_impl import QdrantVectorDBStorage
from magi_core.kg.postgres_impl import PGVectorStorage
...
class TestQdrantDimensionMismatch:
    ...
    def test_qdrant_dimension_mismatch_raises_error(self):
        ...
        with patch(
            "magi_core.kg.qdrant_impl._find_legacy_collection",
