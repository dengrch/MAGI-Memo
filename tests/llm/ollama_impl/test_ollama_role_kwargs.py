...
class _FakeRag:
    def __init__(self):
        ...
        self.ollama_server_infos = SimpleNamespace(
            LIGHTRAG_MODEL="magi_core:latest",
...
def _make_client(monkeypatch) -> tuple[TestClient, _FakeRag]:
    ...
    for module_name in [
        ...
        "magi_core.api.routers",
        "magi_core.api.routers.ollama_api",
    ]:
        sys.modules.pop(module_name, None)
    ollama_api_module = importlib.import_module("magi_core.api.routers.ollama_api")
