...
from magi_core.kg import shared_storage as ss

# Accessed via the module (not ``from``-imports) on purpose: another test in
# the suite reloads magi_core.utils in place, which would leave from-imported
...
from magi_core import utils as lr_utils
