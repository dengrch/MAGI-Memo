"""Spec-compliance tests for :func:`magi_core.sidecar.write_sidecar`.
...
from magi_core.sidecar import writer as _writer
from magi_core.sidecar.writer import (
