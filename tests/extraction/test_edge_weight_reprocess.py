...
import magi_core.operate as operate
from magi_core.operate import _merge_edges_then_upsert
from magi_core.constants import GRAPH_FIELD_SEP
from magi_core.utils import make_relation_chunk_key
...
async def _orchestrate(chunk_results, g, stores, cfg, doc_id="d"):
    from magi_core.operate import merge_nodes_and_edges
