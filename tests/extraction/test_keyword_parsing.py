...
from magi_core.base import QueryParam
from magi_core.operate import _parse_keywords_payload, extract_keywords_only
...
def test_parse_keywords_payload_warns_when_json_repair_is_used():
    ...
    with patch("magi_core.operate.logger.warning") as mocked_warning:
...
async def test_extract_keywords_only_accepts_empty_keyword_cache_without_requery():
    ...
    with patch(
        "magi_core.operate.handle_cache",
