"""Unit tests for the parser registry (magi_core.parser.registry)."""
...
def test_capability_queries_do_not_import_parser_impls():
    ...
    code = (
        "import sys; import magi_core.parser.registry as r; "
        ...
        "assert 'magi_core.parser.external.mineru.parser' not in sys.modules; "
        "print('clean')"
    )
