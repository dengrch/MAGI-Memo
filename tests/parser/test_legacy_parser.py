"""Unit tests for the legacy engine adapter (magi_core.parser.legacy.parser).
...
import magi_core.pipeline as _pipeline
from magi_core.constants import FULL_DOCS_FORMAT_RAW
from magi_core.parser.base import ParseContext
from magi_core.parser.legacy.extractors import LegacyExtractionError
from magi_core.parser.legacy.parser import LegacyParser
...
async def test_legacy_parse_whitespace_only_extraction_raises(
    ...
    monkeypatch.setattr(
        "magi_core.parser.legacy.extractors.extract_text",
...
async def test_legacy_parse_passes_pdf_password_from_env(
    ...
    monkeypatch.setattr("magi_core.parser.legacy.extractors.extract_text", _capture)
