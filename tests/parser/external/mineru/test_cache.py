...
from magi_core.parser.external.mineru import (
    Manifest,
    ManifestFile,
    clear_dir_contents,
...
from magi_core.parser.external.mineru.manifest import write_manifest
...
def test_manifest_round_trip_via_disk(tmp_path: Path) -> None:
    ...
    from magi_core.parser.external.mineru.manifest import load_manifest
