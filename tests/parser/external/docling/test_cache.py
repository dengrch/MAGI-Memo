"""Tests for ``magi_core/parser/external/docling/cache.py``.
...
from magi_core.parser.external import Manifest, ManifestFile, write_manifest
from magi_core.parser.external._common import compute_size_and_hash
