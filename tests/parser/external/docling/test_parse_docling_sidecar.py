...
from magi_core.parser.external import (
    Manifest,
    ManifestFile,
    compute_size_and_hash,
    write_manifest,
)
from magi_core.parser.external.docling.cache import (
    compute_options_signature,
    snapshot_tunable_env,
)
from magi_core.parser.external.docling.client import FIXED_CONSTANTS
...
def _install_fake_download(monkeypatch: pytest.MonkeyPatch) -> dict[str, int]:
    ...
    import magi_core.parser.external.docling.client as client_mod
