...
from magi_core.parser.docx.parse_document import ParagraphRecord
from magi_core.parser.docx.smart_heading.heading_flow import (
    HeadingDecision,
...
from magi_core.parser.docx.smart_heading.style_key import classify_numbering
...
def _propagate_lightrag_logs():
    """The ``magi_core`` logger sets propagate=False; caplog needs it on."""
    lg = logging.getLogger("magi_core")
    old = lg.propagate
    lg.propagate = True
    try:
        yield
...
def test_outline_strong_body_demotion_is_rule_tagged() -> None:
    ...
    from magi_core.parser.docx.smart_heading.guardrails import (
...
def test_outline_other_strong_body_reasons_keep_full_force() -> None:
    ...
    from magi_core.parser.docx.smart_heading import guardrails
...
def test_source_multisentence_gate_real_spacy_end_to_end(monkeypatch) -> None:
    ...
    from magi_core.parser.docx.parse_document import _assemble_blocks_smart
    from magi_core.parser.docx.smart_heading import guardrails
    from magi_core.parser.docx.smart_heading.heading_flow import run_smart_heading
...
def test_cb1_reestimation_recovers_density(monkeypatch, caplog) -> None:
    ...
    warnings: dict = {}
    with caplog.at_level(logging.INFO, logger="magi_core"):
        result = gate_with_cb1(
            records,
            indices,
            fs_base=fs,
...
def test_cb1_graduated_ladder_orders_mln_last_and_ennum_root_deferred() -> None:
    ...
    from magi_core.parser.docx.smart_heading.heading_flow import _cb1_ladder
...
def test_cb1_graduated_outline_and_larger_size_exempt() -> None:
    ...
    from magi_core.parser.docx.smart_heading.heading_flow import _cb1_stage_tag
...
def test_assembler_doc_title_empty_without_title_block() -> None:
    ...
    from magi_core.parser.docx.parse_document import _assemble_blocks_smart
    from magi_core.parser.docx.smart_heading.heading_flow import SmartHeadingResult
...
def test_assembler_toc_retention_keeps_first_lines_as_body() -> None:
    ...
    from magi_core.parser.docx.parse_document import _assemble_blocks_smart
    from magi_core.parser.docx.smart_heading.guardrails import TOC_ELLIPSIS
    from magi_core.parser.docx.smart_heading.heading_flow import SmartHeadingResult
...
def test_title_block_judge_receives_fs_base(monkeypatch) -> None:
    ...
    from magi_core.parser.docx.smart_heading import title_block as tb
    from magi_core.parser.docx.smart_heading.heading_flow import run_smart_heading
...
def test_run_level_audit_exports_metrics(monkeypatch) -> None:
    ...
    from magi_core.parser.docx.smart_heading.heading_flow import _AUDIT_SUMMARY_CHARS
...
def test_table_title_block_end_to_end_assembly(monkeypatch) -> None:
    ...
    from magi_core.parser.docx.parse_document import (
        ParagraphRecord,
        _assemble_blocks_smart,
    )
    from magi_core.parser.docx.smart_heading import guardrails as g
    from magi_core.parser.docx.smart_heading.heading_flow import run_smart_heading
...
def test_early_strong_body_keys_covers_only_chapter_classes() -> None:
    ...
    from magi_core.parser.docx.smart_heading.style_key import (
        CN_CHAPTER,
        CN_CLAUSE,
        EN_CHAPTER,
        EN_CLAUSE,
...
def test_outline_only_fallback_demotes_placeholder(caplog) -> None:
    ...
    warnings: dict = {}
    with caplog.at_level(logging.WARNING, logger="magi_core"):
        out = _outline_only_decisions(records, range(len(records)), warnings=warnings)
...
def test_zero_weight_llm_grant_leaves_rejected_ledger() -> None:
    ...
    from magi_core.parser.docx.smart_heading.heading_flow import _merge_ledger_only
...
def _assemble_bounded_title(monkeypatch, cap_env: str, main: str, sub):
    ...
    from magi_core.parser.docx.parse_document import _assemble_blocks_smart
    from magi_core.parser.docx.smart_heading.heading_flow import SmartHeadingResult
    from magi_core.parser.docx.smart_heading.title_block import compose_doc_title
...
def test_merged_doc_title_weighted_truncation_four_way(monkeypatch) -> None:
    ...
    from magi_core.constants import DEFAULT_DOCX_SMART_HEADING_MAX_CHARS
    from magi_core.parser.docx.smart_heading.guardrails import weighted_char_length
...
def test_merged_doc_title_raw_ceiling_above_cap_four_way(monkeypatch) -> None:
    ...
    from magi_core.constants import MAX_HEADING_LENGTH
