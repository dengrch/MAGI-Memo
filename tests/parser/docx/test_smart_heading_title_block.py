...
from magi_core.parser.docx.smart_heading.title_block import (
    TitleBlockCandidate,
    TitleBlockLLMError,
    compose_doc_title,
...
def test_dominance_ignores_headings_beyond_flank_window(monkeypatch) -> None:
    ...
    import magi_core.parser.docx.smart_heading.title_block as tb
...
def test_table_window_layout_note_only_when_separated() -> None:
    ...
    from magi_core.parser.docx.smart_heading.title_block import _TABLE_LAYOUT_NOTE
...
def test_leading_break_title_keeps_subtitle_in_window(tmp_path) -> None:
    ...
    from magi_core.parser.docx.numbering_resolver import NumberingResolver
    from magi_core.parser.docx.parse_document import (
        _read_document_records,
        parse_styles_outline_levels,
    )
    from magi_core.parser.docx.smart_heading.features import parse_styles_attributes
