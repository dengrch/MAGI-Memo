...
from magi_core.parser.base import ParseContext  # noqa: E402
from magi_core.parser.debug import (  # noqa: E402
    FrozenDateTime,
    build_debug_rag,
)
from magi_core.parser.registry import get_parser  # noqa: E402
...
def _run_new_path(
    ...
    with (
        ...
        mock.patch("magi_core.sidecar.writer.datetime", FrozenDateTime),
    ):
