...
from magi_core.parser.docx.smart_heading.heading_flow import HeadingDecision
...
def test_strip_leading_numbering(text: str, expected: str) -> None:
    from magi_core.parser.docx.smart_heading.guardrails import _strip_leading_numbering
...
def test_heading_max_chars_reads_env_and_floors_below_three(monkeypatch) -> None:
    ...
    from magi_core.parser.docx.smart_heading.guardrails import heading_max_chars
