...
from magi_core.utils import Tokenizer, TokenizerInterface, compute_args_hash
...
def test_native_lightrag_path_produces_stable_merged_text(tmp_path, monkeypatch):
    ...
    async def _run():
        ...
        assert record["parse_format"] == "magi_core"
...
def test_native_lightrag_path_leaves_unknown_table_caption_empty(tmp_path, monkeypatch):
    ...
    async def _run():
        ...
        from magi_core.multimodal_context import enrich_sidecars_with_surrounding
