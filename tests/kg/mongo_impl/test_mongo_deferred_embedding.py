...
from magi_core.kg.mongo_impl import MongoVectorDBStorage
...
def patch_namespace_lock(monkeypatch):
    ...
    with patch("magi_core.kg.mongo_impl.get_namespace_lock", side_effect=factory):
        yield cache
...
def _make_storage(
    ...
    *,
    ...
    from magi_core.kg.mongo_impl import get_namespace_lock
...
async def test_finalize_raises_when_buffer_unflushed_and_still_releases_client():
    ...
    from magi_core.kg.mongo_impl import ClientManager
