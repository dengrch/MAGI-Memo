...
from magi_core.kg.qdrant_impl import (  # noqa: E402
...
def patch_namespace_lock():
    ...
    with patch("magi_core.kg.qdrant_impl.get_namespace_lock", side_effect=factory):
        yield cache
...
def _make_storage(
    ...
    *,
    ...
    from magi_core.kg.qdrant_impl import get_namespace_lock
