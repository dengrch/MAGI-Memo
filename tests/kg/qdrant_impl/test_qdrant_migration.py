...
from magi_core.kg.qdrant_impl import QdrantVectorDBStorage  # noqa: E402


# Mock QdrantClient
@pytest.fixture
def mock_qdrant_client():
    with patch("magi_core.kg.qdrant_impl.QdrantClient") as mock_client_cls:
...
def mock_data_init_lock():
    with patch("magi_core.kg.qdrant_impl.get_data_init_lock") as mock_lock:
