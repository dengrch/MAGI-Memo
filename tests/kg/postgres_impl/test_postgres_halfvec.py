...
from magi_core.kg.postgres_impl import (
    PGVectorStorage,
    PostgreSQLDB,
    _safe_index_name,
)
from magi_core.exceptions import DataMigrationError
...
def mock_data_init_lock():
    with patch("magi_core.kg.postgres_impl.get_data_init_lock") as mock_lock:
...
def mock_client_manager(mock_pg_db):
    with patch("magi_core.kg.postgres_impl.ClientManager") as mock_manager:
...
def mock_embedding_func():
    ...
    # Note: EmbeddingFunc in this version of magi_core supports model_name
