...
from magi_core.utils import EmbeddingFunc, make_relation_vdb_ids
...
class TestPostgresBatchOrdering:
    ...
    def _make_pg_storage():
        ...
        """
        from magi_core.kg.postgres_impl import PGGraphStorage
...
class TestMongoBatchOrdering:
    ...
    async def test_upsert_nodes_batch_uses_ordered_bulk_write(self):
        ...
        from magi_core.kg.mongo_impl import (
            MongoGraphStorage,
