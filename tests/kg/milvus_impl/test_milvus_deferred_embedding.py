...
from magi_core.kg.milvus_impl import MILVUS_MAX_VARCHAR_BYTES, MilvusVectorDBStorage
...
def patch_namespace_lock():
    ...
    with patch("magi_core.kg.milvus_impl.get_namespace_lock", side_effect=factory):
        yield cache
