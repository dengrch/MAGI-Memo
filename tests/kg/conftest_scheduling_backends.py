...
async def _build_postgres(_tmp_path) -> Any:
    from magi_core.kg.postgres_impl import ClientManager, PGDocStatusStorage
...
async def _build_mongo(_tmp_path) -> Any:
    from magi_core.kg.mongo_impl import MongoDocStatusStorage
...
async def _build_opensearch(_tmp_path) -> Any:
    from magi_core.kg.opensearch_impl import OpenSearchDocStatusStorage
