...
import magi_core.tools.rebuild_vdb as rebuild_vdb
from magi_core.tools.rebuild_vdb import (
...
def single_attempt_vdb_ops(monkeypatch):
    ...
    import magi_core.utils_graph as utils_graph
...
async def test_merge_relation_vdb_delete_failure_raises_consistency_error(
    ...
    from magi_core.utils_graph import _merge_entities_impl
    ...
    assert "magi_core-rebuild-vdb" in str(excinfo.value)
...
async def test_merge_source_entity_delete_failure_raises_consistency_error(
    ...
    assert "magi_core-rebuild-vdb" in message
...
async def test_check_only_stub_carries_embedding_model_name(monkeypatch):
    ...
    import magi_core.kg.factory as kg_factory
    from magi_core.tools.rebuild_vdb import RebuildTool
...
def _runnable_tool(monkeypatch, inputs):
    ...
    import magi_core.kg.shared_storage as shared
