...
from magi_core.evaluation.offline_retrieval_check import (
    audit_samples,
    load_cases,
    load_documents,
    load_oracle,
...
class OfflineRetrievalCheckTests(unittest.TestCase):
    ...
    def test_sample_oracle_has_full_recall_at_two(self):
        results = audit_samples(
            load_cases(Path("src/magi_core/evaluation/sample_dataset.json")),
            load_oracle(
                Path("src/magi_core/evaluation/sample_retrieval_oracle.json")
            ),
            load_documents(Path("src/magi_core/evaluation/sample_documents")),
        )
