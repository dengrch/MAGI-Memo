...
from magi_core.constants import DEFAULT_P_REFERENCES_HEADINGS
from magi_core.utils import Tokenizer, TokenizerInterface, logger as _lightrag_logger
...
def test_drop_references_emits_info_log(tmp_path, caplog):
    ...
    # The magi_core logger sets propagate=False, so caplog can't see it by
