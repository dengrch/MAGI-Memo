...
from magi_core.chunker import chunking_by_semantic_vector  # noqa: E402
from magi_core.utils import EmbeddingFunc, Tokenizer, TokenizerInterface  # noqa: E402
...
def test_semantic_groups_mirror_matches_upstream_split_text():
    ...
    from magi_core.chunker.semantic_vector import _semantic_groups_with_spans
    from magi_core.constants import DEFAULT_SENTENCE_SPLIT_REGEX
