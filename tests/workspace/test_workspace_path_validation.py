"""Unit tests for ``magi_core.utils.validate_workspace``.
...
from magi_core.utils import validate_workspace
...
def _import_document_manager():
    ...
    Importing ``magi_core.api`` modules triggers the server's argparse against
    ...
    try:
        ...
        from magi_core.api.routers.document_routes import DocumentManager
