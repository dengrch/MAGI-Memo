#!/usr/bin/env python3
"""Live smoke test for the public LightRAG core SDK surface."""
...
LIGHTRAG_ROOT = ROOT / "LightRAG"
ARTIFACTS = ROOT / "test" / "artifacts"
WORKING_DIR = ARTIFACTS / "rag_storage"
WORKSPACE = "magi_memo_core_test"
SAMPLES = LIGHTRAG_ROOT / "inputs" / "magi_memo_dev" / "__parsed__"
ENV_FILE = LIGHTRAG_ROOT / ".env"
