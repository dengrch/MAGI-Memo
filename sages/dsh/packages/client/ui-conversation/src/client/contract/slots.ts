...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /**
     * The MAGI memory-mode selector immediately left of the model selector.
     * It is empty when no memory provider contributes a control.
     */
    'conversation.input.memory': { kind: 'single'; scope: 'session'; owner: InputControlOwnerProps }
    /**
...
export type ComposerBarProps =
  ...
  & PropsRenderSlots<'conversation.input.plan' | 'conversation.input.memory' | 'conversation.input.model'>
