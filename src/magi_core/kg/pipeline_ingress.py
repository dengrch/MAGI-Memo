...
This module deliberately does NOT import :mod:`magi_core.kg.shared_storage` —
...
from magi_core.constants import DEFAULT_MAX_UNACKED_MANUAL_RETRIES
...
class AsyncioPipelineIngress:
    ...
    ``magi_core.py``: objects created under one ``asyncio.run()`` keep working
