...
from magi_core.file_atomic import reap_orphan_tmp_files
...
from magi_core.exceptions import StorageNotInitializedError
...
class JsonKVStorage(BaseKVStorage):
    ...
    async def _migrate_legacy_cache_structure(self, data: dict) -> dict:
        ...
        """
        from magi_core.utils import generate_cache_key
