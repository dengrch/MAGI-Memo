...
from magi_core.file_atomic import atomic_write, reap_orphan_tmp_files
from magi_core.types import KnowledgeGraph, KnowledgeGraphNode, KnowledgeGraphEdge
from magi_core.utils import logger, validate_workspace
from magi_core.base import BaseGraphStorage
...
class NetworkXStorage(BaseGraphStorage):
    ...
    async def upsert_node(self, node_id: str, node_data: dict[str, str]) -> None:
        ...
        Persistence:
            ...
            a subsequent ``index_done_callback``. In ``magi_core.py`` this
