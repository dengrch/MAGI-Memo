...
:func:`magi_core.sidecar.writer.write_sidecar` and
:func:`magi_core.utils_pipeline.load_lightrag_document_content` build it as
...
from magi_core.chunk_schema import normalize_chunk_sidecar
from magi_core.exceptions import ChunkBlockMatchError
from magi_core.utils import logger

# Separator used to join block content into the merged document text. Must match
# magi_core/sidecar/writer.py and magi_core/utils_pipeline.py.
_BLOCK_SEPARATOR = "\n\n"
