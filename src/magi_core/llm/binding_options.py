...
from magi_core.constants import DEFAULT_TEMPERATURE
    ...
    def generate_dot_env_sample(cls):
        ...
        sample_top = (
            ...
            + (
                ...
                "#\n"
                "# To generate run:\n"
                "# $ python -m magi_core.llm.binding_options\n"
            )
            + "#" * 80
            + "\n"
        )
...
# ``magi_core/llm/bedrock.py`` for the whitelist — any field added here that is
...
#
# Usage:
#   python -m magi_core.llm.binding_options           # Generate .env sample
#   python -m magi_core.llm.binding_options test      # Test argument parsing
#
# =============================================================================
