...
# entity_name / src_id / tgt_id fields in magi_core/kg/milvus_impl.py.
...
# by magi_core/parser/docx/smart_heading (same live-env pattern as the
...
# enqueue docs_format (the 'magi_core' ingestion entrypoint was removed).
FULL_DOCS_FORMAT_LIGHTRAG = "magi_core"  # content in LightRAG Document files
FULL_DOCS_FORMAT_PENDING_PARSE = (
    "pending_parse"  # file saved but not yet parsed; parse_native will read from disk
)
# Marker prefix for full_docs.content when format=magi_core.
...
# magi_core.parser.registry (ParserSpec table) — the single source of truth.
