...
Usage:
    # Use defaults (sample_dataset.json, http://localhost:34913)
    ...
    python magi_core/evaluation/eval_rag_quality.py --ragendpoint http://my-server.com:34913
    python magi_core/evaluation/eval_rag_quality.py -r http://my-server.com:34913

    # Specify both
    python magi_core/evaluation/eval_rag_quality.py -d my_test.json -r http://localhost:34913

    # Get help
    python magi_core/evaluation/eval_rag_quality.py --help

Results are saved to: magi_core/evaluation/results/
...
class RAGEvaluator:
    ...
    def __init__(self, test_dataset_path: str = None, rag_api_url: str = None):
        ...
        Args:
            ...
            rag_api_url: Base URL of LightRAG API (e.g., http://localhost:34913)
        ...
        if rag_api_url is None:
            rag_api_url = os.getenv("LIGHTRAG_API_URL", "http://localhost:34913")
    ...
    async def generate_rag_response(
        ...
        try:
            ...
            raise Exception(
                ...
                f"   python -m magi_core.api.lightrag_server\n"
                f"   Error: {str(e)}"
            )
...
async def main():
    ...
    Command-line arguments:
        ...
        --ragendpoint, -r: LightRAG API endpoint URL (default: http://localhost:34913 or $LIGHTRAG_API_URL)
...
Examples:
  ...
  python magi_core/evaluation/eval_rag_quality.py -d my_test.json -r http://localhost:34913
        ...
        parser.add_argument(
            ...
            type=str,
            default=None,
            help="LightRAG API endpoint URL (default: http://localhost:34913 or $LIGHTRAG_API_URL environment variable)",
        )
