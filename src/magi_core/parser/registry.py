...
Like :data:`magi_core.kg.STORAGES` / ``STORAGE_IMPLEMENTATIONS``, this module
...
if TYPE_CHECKING:
    from magi_core.parser.base import BaseParser
...
_REGISTRY: dict[str, ParserSpec] = {
    PARSER_ENGINE_NATIVE: ParserSpec(
        ...
        # source suffix (see magi_core.parser.native_dispatch).
        impl="magi_core.parser.native_dispatch:NativeParser",
    ...
    PARSER_ENGINE_LEGACY: ParserSpec(
        ...
        impl="magi_core.parser.legacy.parser:LegacyParser",
    ...
    PARSER_ENGINE_MINERU: ParserSpec(
        ...
        impl="magi_core.parser.external.mineru.parser:MinerUParser",
    ...
    PARSER_ENGINE_DOCLING: ParserSpec(
        ...
        impl="magi_core.parser.external.docling.parser:DoclingParser",
    ...
    PARSER_ENGINE_REUSE: ParserSpec(
        ...
        impl="magi_core.parser.noop:ReuseParser",
        suffixes=frozenset(),
        user_selectable=False,
    ),
    PARSER_ENGINE_PASSTHROUGH: ParserSpec(
        engine_name=PARSER_ENGINE_PASSTHROUGH,
        impl="magi_core.parser.noop:PassthroughParser",
        suffixes=frozenset(),
        user_selectable=False,
    ),
}
