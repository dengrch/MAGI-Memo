...
:func:`magi_core.parser.markdown.extract.extract_markdown`, threaded through
...
from magi_core.parser._html_table import (
    extract_html_table_info,
    extract_thead_html,
    html_table_inner_body,
    unwrap_html_table,
)
from magi_core.parser.markdown.extract import (
    DRAWING_MARKER_RE,
    EQUATION_MARKER_RE,
    PREFACE_HEADING,
    TABLE_MARKER_RE,
