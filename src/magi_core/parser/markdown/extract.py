...
- :class:`magi_core.parser.markdown.ir_builder.NativeMarkdownIRBuilder` later
...
from magi_core.parser._html_table import starts_with_html_tag
from magi_core.parser._markdown import render_heading_line
