...
from magi_core.parser.param_schema import (
    _parse_bool,
    parse_chunk_params,
    parse_engine_params,
...
from magi_core.utils import get_env_value, logger, parse_optional_float
...
def default_chunker_config() -> dict[str, Any]:
    ...
    *strategy-specific* env vars (``CHUNK_F_SIZE``,
    ...
    :func:`magi_core.addon_params.default_addon_params`; users can mutate
...
def validate_smart_heading_dependencies(parser_rules: str | None = None) -> None:
    ...
    from magi_core.parser.docx.smart_heading.nlp import ensure_spacy_models_installed
...
def _validate_smart_heading_max_chars() -> None:
    ...
    source :func:`~magi_core.parser.docx.smart_heading.guardrails.validate_heading_max_chars_env`,
...
def resolve_stored_document_parser_engine(
    ...
    if content_data:
        ...
        # All magi_core rows reuse the already-parsed sidecar (sidecar optional;
