...
from magi_core.constants import MINERU_RAW_DIR_SUFFIX, PARSER_ENGINE_MINERU
...
class MinerUParser(ExternalParserBase):
    ...
    def is_bundle_valid(
        ...
        *,
        ...
        from magi_core.parser.external.mineru import is_bundle_valid
    ...
    async def download_into(
        ...
        *,
        ...
        from magi_core.parser.external.mineru import MinerURawClient
    ...
    def build_ir(self, raw_dir: Path, document_name: str) -> "IRDoc":
        from magi_core.parser.external.mineru import MinerUIRBuilder
