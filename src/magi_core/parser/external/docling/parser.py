...
from magi_core.constants import DOCLING_RAW_DIR_SUFFIX, PARSER_ENGINE_DOCLING
...
class DoclingParser(ExternalParserBase):
    ...
    def is_bundle_valid(
        ...
        *,
        ...
        from magi_core.parser.external.docling import is_bundle_valid
    ...
    async def download_into(
        ...
        *,
        ...
        from magi_core.parser.external.docling import DoclingRawClient
    ...
    def build_ir(self, raw_dir: Path, document_name: str) -> "IRDoc":
        from magi_core.parser.external.docling import DoclingIRBuilder
