...
from magi_core.constants import DOCLING_RAW_DIR_SUFFIX
...
from magi_core.parser.external.docling.ir_builder import (  # noqa: E402
    DoclingIRBuilder,
)
from magi_core.parser.external.docling.cache import (  # noqa: E402
    is_bundle_valid,
)
from magi_core.parser.external.docling.client import (  # noqa: E402
    DoclingRawClient,
)
