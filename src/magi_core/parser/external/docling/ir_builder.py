...
from magi_core.parser.external._common import env_json
from magi_core.parser.external.docling.manifest import select_main_json
...
def _build_ir_table(
    ...
    # filter in magi_core/parser/external/mineru/ir_builder.py). Drop the
