...
from magi_core.constants import PARSER_ENGINE_NATIVE
...
class NativeDocxParser(NativeParserBase):
    ...
    def extract(
        ...
        *,
        ...
        from magi_core.parser.docx.drawing_image_extractor import (
            DrawingExtractionContext,
            load_relationships,
        )
        from magi_core.parser.docx.parse_document import extract_docx_blocks
    ...
    def build_ir(
        ...
        *,
        ...
        from magi_core.parser.docx.ir_builder import NativeDocxIRBuilder
