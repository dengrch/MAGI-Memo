...
from magi_core.parser._markdown import (
    render_heading_line,
...
# MAX_HEADING_LENGTH is imported from magi_core.constants above (a raw-char UI
...
def _read_document_records(
    ...
    *,
    ...
    if style_attributes is not None:
        from magi_core.parser.docx.smart_heading.features import (
...
def extract_docx_blocks(
    ...
    *,
    ...
    from magi_core.parser.docx.smart_heading import guardrails as _guards
