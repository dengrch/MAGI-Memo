...
engine names) and the debug CLI (``magi_core.parser.cli.main``, before
...
ENTRY_POINT_GROUP = "magi_core.parsers"
...
def load_third_party_parsers(*, force: bool = False) -> list[str]:
    """Discover and run all ``magi_core.parsers`` entry points.
