...
def main():
    from magi_core.api.utils_api import display_splash_screen, check_env_file
    from magi_core.api.config import global_args, initialize_config
    ...
    if (
        ...
        print("     magi_core-server --workers 1")
        print("=" * 80 + "\n")
        sys.exit(1)
    ...
    class GunicornApp(BaseApplication):
        ...
        def load(self):
            ...
            from magi_core.api.lightrag_server import get_application
