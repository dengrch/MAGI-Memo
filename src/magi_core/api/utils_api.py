...
from magi_core.api.runtime_validation import validate_runtime_target_from_env_file
...
def display_splash_screen(args: argparse.Namespace) -> None:
    ...
    line1_text = f"MAGI Memo Server v{core_version}/{api_version}"
    line2_text = "Episode and Atom Memory Core"
