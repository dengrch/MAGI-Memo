...
from magi_core.api.routers.document_routes import (
    DocumentManager,
    create_document_routes,
)
from magi_core.parser.plugins import load_third_party_parsers
from magi_core.parser.routing import (
    parser_rules_from_env,
    validate_parser_routing_config,
    validate_smart_heading_dependencies,
)
from magi_core.parser.external.mineru.cache import MinerUParserOptions
...
def _inject_swagger_theme(html: str, theme: str) -> str:
    ...
    # single boolean attribute `data-magi_core-docs-dark` on <html>. CSS below
          ...
          (function () {{
            ...
            function apply(value) {{
              ...
              if (resolveDark(currentTheme)) {{
                root.setAttribute('data-magi_core-docs-dark', '1');
              }} else {{
                root.removeAttribute('data-magi_core-docs-dark');
              }}
            }}
            apply(currentTheme);
            ...
            window.addEventListener('message', function (event) {{
              var data = event.data;
              if (!data || data.type !== 'magi_core:set-docs-theme') return;
              apply(data.theme);
            }});
          }})();
        </script>
        <style>
          html[data-magi_core-docs-dark="1"] {{
            color-scheme: dark;
          }}

          html[data-magi_core-docs-dark="1"] body,
          html[data-magi_core-docs-dark="1"] .swagger-ui,
          html[data-magi_core-docs-dark="1"] .swagger-ui .scheme-container,
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models,
          html[data-magi_core-docs-dark="1"] .swagger-ui .model-box,
          html[data-magi_core-docs-dark="1"] .swagger-ui .opblock,
          html[data-magi_core-docs-dark="1"] .swagger-ui .dialog-ux .modal-ux,
          html[data-magi_core-docs-dark="1"] .swagger-ui .auth-container {{
            background: #0f172a;
            color: #e5e7eb;
          }}

          html[data-magi_core-docs-dark="1"] .swagger-ui .info .title,
          html[data-magi_core-docs-dark="1"] .swagger-ui .opblock-tag,
          html[data-magi_core-docs-dark="1"] .swagger-ui .opblock .opblock-summary-description,
          html[data-magi_core-docs-dark="1"] .swagger-ui .model-title,
          html[data-magi_core-docs-dark="1"] .swagger-ui .parameter__name,
          html[data-magi_core-docs-dark="1"] .swagger-ui .parameter__type,
          html[data-magi_core-docs-dark="1"] .swagger-ui .response-col_status,
          html[data-magi_core-docs-dark="1"] .swagger-ui .response-col_description,
          html[data-magi_core-docs-dark="1"] .swagger-ui .auth-container h4,
          html[data-magi_core-docs-dark="1"] .swagger-ui .auth-container label,
          html[data-magi_core-docs-dark="1"] .swagger-ui .auth-container p,
          html[data-magi_core-docs-dark="1"] .swagger-ui .markdown p,
          html[data-magi_core-docs-dark="1"] .swagger-ui .markdown li,
          html[data-magi_core-docs-dark="1"] .swagger-ui .renderedMarkdown p,
          html[data-magi_core-docs-dark="1"] .swagger-ui .renderedMarkdown li,
          html[data-magi_core-docs-dark="1"] .swagger-ui table thead tr th,
          html[data-magi_core-docs-dark="1"] .swagger-ui table tbody tr td,
          html[data-magi_core-docs-dark="1"] .swagger-ui .tab li,
          html[data-magi_core-docs-dark="1"] .swagger-ui .tab li button.tablinks {{
            color: #e5e7eb;
          }}

          html[data-magi_core-docs-dark="1"] .swagger-ui .opblock-description-wrapper p,
          html[data-magi_core-docs-dark="1"] .swagger-ui .opblock-external-docs-wrapper p,
          html[data-magi_core-docs-dark="1"] .swagger-ui .response-col_links {{
            color: #cbd5f5;
          }}

          html[data-magi_core-docs-dark="1"] .swagger-ui input,
          html[data-magi_core-docs-dark="1"] .swagger-ui textarea,
          html[data-magi_core-docs-dark="1"] .swagger-ui select {{
            background: #020617;
            border-color: #334155;
            color: #f8fafc;
          }}

          html[data-magi_core-docs-dark="1"] .swagger-ui .markdown code,
          html[data-magi_core-docs-dark="1"] .swagger-ui .renderedMarkdown code,
          html[data-magi_core-docs-dark="1"] .swagger-ui .highlight-code,
          html[data-magi_core-docs-dark="1"] .swagger-ui .highlight-code pre,
          html[data-magi_core-docs-dark="1"] .swagger-ui .microlight,
          html[data-magi_core-docs-dark="1"] .swagger-ui .body-param__example,
          html[data-magi_core-docs-dark="1"] .swagger-ui .example,
          html[data-magi_core-docs-dark="1"] .swagger-ui .model-example pre {{
            background: #020617;
            color: #e2e8f0;
          }}
          ...
          html[data-magi_core-docs-dark="1"] .swagger-ui .tab li.active button.tablinks,
          html[data-magi_core-docs-dark="1"] .swagger-ui .tab li.tabitem.active {{
            color: #f8fafc;
            border-bottom-color: #34d399;
          }}

          html[data-magi_core-docs-dark="1"] .swagger-ui .btn.authorize,
          html[data-magi_core-docs-dark="1"] .swagger-ui .auth-wrapper .authorize {{
            background: #064e3b;
            border-color: #34d399;
            color: #d1fae5;
          }}

          html[data-magi_core-docs-dark="1"] .swagger-ui .btn.authorize svg {{
            fill: #d1fae5;
          }}
          ...
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models,
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models.is-open,
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models h4,
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models .model-container,
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models .models-control,
          html[data-magi_core-docs-dark="1"] .swagger-ui .model-box {{
            background: #111827;
            border-color: #334155;
          }}
          ...
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models h4,
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models h4 button,
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models h4 a,
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models h4 span,
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models .models-control,
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models .models-control button,
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models .model-toggle,
          html[data-magi_core-docs-dark="1"] .swagger-ui .model,
          html[data-magi_core-docs-dark="1"] .swagger-ui .model .model-title__text,
          html[data-magi_core-docs-dark="1"] .swagger-ui .model .property,
          html[data-magi_core-docs-dark="1"] .swagger-ui .model .prop-name,
          html[data-magi_core-docs-dark="1"] .swagger-ui .model .prop-type,
          html[data-magi_core-docs-dark="1"] .swagger-ui .model .prop-format,
          html[data-magi_core-docs-dark="1"] .swagger-ui .expand-operation,
          html[data-magi_core-docs-dark="1"] .swagger-ui .expand-operation span {{
            color: #e5e7eb;
          }}

          html[data-magi_core-docs-dark="1"] .swagger-ui section.models h4 svg,
          html[data-magi_core-docs-dark="1"] .swagger-ui section.models .models-control svg,
          html[data-magi_core-docs-dark="1"] .swagger-ui .model-toggle::after,
          html[data-magi_core-docs-dark="1"] .swagger-ui .expand-operation svg,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-accordion__icon svg,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-accordion__icon svg path {{
            fill: #e5e7eb;
          }}
          ...
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12__title,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-property .json-schema-2020-12__title,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-expand-deep-button,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-accordion,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name--primary,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--primary,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute--primary,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name--primary,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--primary,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--const .json-schema-2020-12-json-viewer__name,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--const .json-schema-2020-12-json-viewer__value,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--default .json-schema-2020-12-json-viewer__name,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--default .json-schema-2020-12-json-viewer__value,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--enum .json-schema-2020-12-json-viewer__name,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--enum .json-schema-2020-12-json-viewer__value,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--examples .json-schema-2020-12-json-viewer__name,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--examples .json-schema-2020-12-json-viewer__value {{
            color: #e5e7eb;
          }}

          /* Secondary / extension / description text — keep them visible but
             dimmer than primary titles. */
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name--secondary,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--secondary,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name--extension,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--extension,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--description,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name--secondary,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--secondary,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name--extension,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--extension,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer-extension-keyword .json-schema-2020-12-json-viewer__name,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer-extension-keyword .json-schema-2020-12-json-viewer__value,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute--muted {{
            color: #cbd5f5;
          }}
          ...
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--warning,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--warning,
          html[data-magi_core-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute--warning {{
            color: #fca5a5;
            border-color: #fca5a5;
          }}
          ...
          /* Per-operation Authorize lock icon. Swagger renders it via
             ...
             states. */
          html[data-magi_core-docs-dark="1"] .swagger-ui .authorization__btn svg,
          html[data-magi_core-docs-dark="1"] .swagger-ui .authorization__btn .locked,
          html[data-magi_core-docs-dark="1"] .swagger-ui .authorization__btn .unlocked {{
            fill: #e5e7eb;
          }}
        </style>
        """
...
class LLMConfigCache:
    ...
    def __init__(self, args):
        ...
        if args.llm_binding in ["openai", "azure_openai"]:
            from magi_core.llm.binding_options import OpenAILLMOptions
        ...
        if args.llm_binding == "gemini":
            from magi_core.llm.binding_options import GeminiLLMOptions
        ...
        if args.llm_binding == "bedrock":
            from magi_core.llm.binding_options import BedrockLLMOptions
        ...
        if args.llm_binding == "ollama":
            try:
                from magi_core.llm.binding_options import OllamaLLMOptions
        ...
        if args.embedding_binding == "ollama":
            try:
                from magi_core.llm.binding_options import OllamaEmbeddingOptions
        ...
        if args.embedding_binding == "gemini":
            try:
                from magi_core.llm.binding_options import GeminiEmbeddingOptions
...
def create_optimized_embedding_function(
    ...
    try:
        if binding == "openai":
            from magi_core.llm.openai import openai_embed

            provider_func = openai_embed
        elif binding == "ollama":
            from magi_core.llm.ollama import ollama_embed

            provider_func = ollama_embed
        elif binding == "gemini":
            from magi_core.llm.gemini import gemini_embed

            provider_func = gemini_embed
        elif binding == "jina":
            from magi_core.llm.jina import jina_embed

            provider_func = jina_embed
        elif binding == "azure_openai":
            from magi_core.llm.azure_openai import azure_openai_embed

            provider_func = azure_openai_embed
        elif binding == "bedrock":
            from magi_core.llm.bedrock import bedrock_embed

            provider_func = bedrock_embed
        elif binding == "lollms":
            from magi_core.llm.lollms import lollms_embed

            provider_func = lollms_embed
        elif binding == "voyageai":
            from magi_core.llm.voyageai import voyageai_embed
...
def create_embedding_function_from_args(
    ...
    so that offline tools (e.g. magi_core-rebuild-vdb) can embed in exactly
...
def check_frontend_build():
    ...
    try:
        source_dir = Path(__file__).parent.parent.parent / "webui"
        ...
        # Key configuration files in the src/webui root directory.
        key_files = [
...
def create_app(args):
    ...
    # Discover third-party parser engines (``magi_core.parsers`` entry points)
    ...
    async def lifespan(app: FastAPI):
        ...
        try:
            ...
            if getattr(rag, "max_pending_documents", 0) > 0:
                from magi_core.utils_pipeline import count_active_documents
    ...
    base_description = (
        "Providing the MAGI Memo Episode/Atom memory API, WebUI, graph retrieval, "
        "and Ollama model emulation"
    )
    swagger_description = (
        base_description
    ...
    def create_optimized_azure_openai_llm_func(
        ...
        async def optimized_azure_openai_model_complete(
            ...
            **kwargs,
            ...
            from magi_core.llm.azure_openai import azure_openai_complete_if_cache
    ...
    def create_optimized_gemini_llm_func(
        ...
        async def optimized_gemini_model_complete(
            ...
            **kwargs,
            ...
            from magi_core.llm.gemini import gemini_complete_if_cache
    ...
    def create_llm_model_func(binding: str):
        ...
        try:
            if binding == "lollms":
                from magi_core.llm.lollms import lollms_model_complete

                return lollms_model_complete
            elif binding == "ollama":
                from magi_core.llm.ollama import ollama_model_complete
    ...
    def create_role_llm_func(role: str, override_meta: dict | None = None):
        ...
        try:
            if role_binding == "ollama":
                from magi_core.llm.ollama import _ollama_model_if_cache
            ...
            if role_binding == "lollms":
                from magi_core.llm.lollms import lollms_model_if_cache
            ...
            if role_binding == "bedrock":
                from magi_core.llm.bedrock import bedrock_complete_if_cache
    ...
    from magi_core.api.config import OllamaServerInfos
            ...
            status_data.update(
                {
                    ...
                    # magi_core/pipeline_metrics.py for the boundary.
...
def configure_logging():
    ...
    for logger_name in ["uvicorn", "uvicorn.access", "uvicorn.error", "magi_core"]:
    ...
    print(f"\nMAGI Memo log file: {log_file_path}\n")
    ...
    logging.config.dictConfig(
        {
            ...
            "filters": {
                "path_filter": {
                    "()": "magi_core.utils.LightragPathFilter",
                },
            },
        }
    )
