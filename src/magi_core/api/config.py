...
from magi_core import ROLES
from magi_core.utils import get_env_value, logger
from magi_core.llm.binding_options import (
    BedrockLLMOptions,
...
from magi_core.base import OllamaServerInfos
import sys
...
DEFAULT_TOKEN_SECRET = "magi_core-jwt-default-secret-key!"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input-dir",
        default=get_env_value("INPUT_DIR", "./mgc-test/inputs"),
        help="Directory containing input documents (default: from env or ./mgc-test/inputs)",
    )
    ...
    parser.add_argument(
        ...
        help="API key for authentication. This protects magi_core server against unauthorized access",
    )
    ...
    parser.add_argument(
        ...
        help="Name for the simulated Ollama model (default: from env or magi_core)",
    )
    ...
    # --- Per-role LLM configuration (driven by magi_core.ROLES registry) ---
    for spec in ROLES:
