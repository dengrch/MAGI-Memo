...
async def _merge_entities_impl(
    ...
    *,
    ...
    Failure semantics:
        ...
        rebuild tool (``magi_core-rebuild-vdb``) restores full consistency.
    """
    ...
    if relations_to_delete:
        try:
            ...
            raise VectorStorageConsistencyError(
                ...
                "and run the offline rebuild tool (magi_core-rebuild-vdb) to restore "
                "consistency."
            ) from e
    ...
    for rel_data in relation_updates.values():
        ...
        try:
            ...
            raise VectorStorageConsistencyError(
                ...
                "the offline rebuild tool (magi_core-rebuild-vdb) to restore consistency."
            ) from e
        logger.debug(
    ...
    try:
        ...
        raise VectorStorageConsistencyError(
            ...
            "server and run the offline rebuild tool (magi_core-rebuild-vdb) to restore consistency."
        ) from e
    ...
    for entity_name in source_entities:
        ...
        try:
            ...
            raise VectorStorageConsistencyError(
                ...
                "tool (magi_core-rebuild-vdb) to clear the stale record and restore "
                "consistency."
            ) from e
    ...
    try:
        ...
        raise VectorStorageConsistencyError(
            ...
            "(magi_core-rebuild-vdb) to restore consistency."
        ) from e
