...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="magi_core-download-cache",
        description="Download cache files for LightRAG offline deployment",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Download to default location (~/.tiktoken_cache)
  magi_core-download-cache

  # Download to specific directory
  magi_core-download-cache --cache-dir ./offline_cache/tiktoken

  # Download specific models only
  magi_core-download-cache --models gpt-4o-mini gpt-4
  ...
  magi_core-download-cache --spacy

  # Install the spaCy models straight into the current environment
  magi_core-download-cache --spacy --spacy-install
