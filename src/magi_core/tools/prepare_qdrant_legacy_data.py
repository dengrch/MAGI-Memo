...
Usage:
    python -m magi_core.tools.prepare_qdrant_legacy_data
    # or
    python magi_core/tools/prepare_qdrant_legacy_data.py

    # Specify custom workspace
    python -m magi_core.tools.prepare_qdrant_legacy_data --workspace space1

    # Process specific collection types only
    python -m magi_core.tools.prepare_qdrant_legacy_data --types chunks,entities

    # Dry run (preview only, no actual changes)
    python -m magi_core.tools.prepare_qdrant_legacy_data --dry-run
"""
