...
Usage:
    python -m magi_core.tools.clean_llm_query_cache
    # or
    python magi_core/tools/clean_llm_query_cache.py
...
from magi_core.kg.shared_storage import set_all_update_flags
from magi_core.namespace import NameSpace
from magi_core.utils import setup_logger
...
class CleanupTool:
    ...
    def get_storage_class(self, storage_name: str):
        ...
        if storage_name == "JsonKVStorage":
            from magi_core.kg.json_kv_impl import JsonKVStorage

            return JsonKVStorage
        elif storage_name == "RedisKVStorage":
            from magi_core.kg.redis_impl import RedisKVStorage

            return RedisKVStorage
        elif storage_name == "PGKVStorage":
            from magi_core.kg.postgres_impl import PGKVStorage

            return PGKVStorage
        elif storage_name == "MongoKVStorage":
            from magi_core.kg.mongo_impl import MongoKVStorage

            return MongoKVStorage
        elif storage_name == "OpenSearchKVStorage":
            from magi_core.kg.opensearch_impl import OpenSearchKVStorage
