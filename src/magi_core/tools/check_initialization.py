...
Usage:
    ...
    python -m magi_core.tools.check_initialization --demo
"""
...
from magi_core.base import StoragesStatus
...
async def demo():
    ...
    from magi_core.llm.openai import openai_embed, gpt_4o_mini_complete
