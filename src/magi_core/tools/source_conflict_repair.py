...
from ``.env``, same as the server)::
    ...
    python -m magi_core.tools.source_conflict_repair list [--limit 50] [--all]
    python -m magi_core.tools.source_conflict_repair repair \\
...
from magi_core.base import CURSOR_END, CURSOR_START, SourceConflictSummary
