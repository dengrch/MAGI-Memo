...
MAGI Memo WebUI is the retained React interface for indexing Episodes, querying memory, and exploring the Neo4j projection.
...
2. **Install Dependencies:**
    ...
    In the `src/webui` directory, run the following command to install project dependencies:
...
3. **Build the Project:**
    ...
    This command will bundle the project and output the built files to the `src/magi_core/api/webui` directory.
...
- **Start the Development Server:**
  ...
  integrated MAGI Memo server at `http://127.0.0.1:34913` by default.

  For normal use, build the WebUI and start `magi-core-server`. The integrated
  service exposes the WebUI at [http://127.0.0.1:34913/](http://127.0.0.1:34913/),
  the API documentation at [http://127.0.0.1:34913/docs](http://127.0.0.1:34913/docs),
